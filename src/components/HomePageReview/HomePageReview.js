...
const HomePageReview = ({ homeReview }) => {
    const { name, picture, country, rating, people, review_text, review_time } = homeReview;

    return (
        <article className='bg-white rounded-lg shadow-lg  mx-auto mb-10 p-4'>
            <div className="flex items-center flex-col  mb-4 space-x-4">
            ...
            <p className="mb-2 font-light text-gray-500">{review_text.slice(0,120)+'...'}</p>
            ...
            <aside>
                ...
                <div className="flex items-center justify-center mt-3 space-x-3 divide-x divide-gray-200 ">
